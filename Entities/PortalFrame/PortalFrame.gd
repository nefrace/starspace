...
@export var spawn_timer: int = 60
var spawn_timer_max: int
var timer: Timer = Timer.new()
@export var mothership: PackedScene
var debris_in_line: bool = false
var ship_is_spawned: bool = false
...
func on_timer_timeout():
	...
	if spawn_timer == 0 && !ship_is_spawned:
		ship_is_spawned = true
